//! Red-black tree based defragmentation buffer that maintains
//! inserted and free intervals.
//!
//! ```rust
...
/// Red-black tree based degragmentation buffer that maintains
/// inserted and free intervals.
#[derive(Debug)]
...
impl DefragBuf {
    ...
    pub fn free_intervals(&self) -> impl Iterator<Item = Range<usize>> + '_ {
